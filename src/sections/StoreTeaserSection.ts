  ...
  return `
    <section id="loja" class="relative py-20 md:py-24 bg-cor-fundo scroll-mt-24 md:scroll-mt-28 overflow-hidden">
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-6">
        <a
          href="${STORE_LINK}"
          class="group relative block overflow-hidden rounded-[2rem] md:rounded-[2.5rem] shadow-[0_16px_42px_rgba(0,0,0,0.28)] bg-[#0b1e17] md:bg-no-repeat md:bg-contain md:bg-center md:aspect-[1549/637] md:[background-image:url('/media/bannerloja.png')]"
        >
          <img
          ...
          <div class="relative z-10 p-5 sm:p-6 md:p-10 md:h-full max-w-2xl flex flex-col justify-center">
              ...
              <h2 class="mt-2 text-xl sm:text-2xl md:text-4xl font-black text-cor-texto tracking-tight">ACESSE NOSSA LOJA</h2>
              ...
              <span class="self-start mt-4 md:mt-6 inline-flex items-center justify-center gap-2 bg-cor-primaria group-hover:bg-cor-destaque text-cor-escura px-5 md:px-6 py-2.5 md:py-3 rounded-full font-bold uppercase tracking-wider text-xs md:text-sm transition-colors">
                Ir para loja
                <span>→</span>
              </span>
              </div>
