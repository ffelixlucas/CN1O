...
export function LocationSection() {
  return `
    <section id="localizacao" class="relative py-20 md:py-32 bg-cor-fundo scroll-mt-24 md:scroll-mt-28 overflow-hidden">
              ...
              <div>
                ...
                <div class="mt-3 space-y-2.5">
                  <a
                    ...
                    class="flex min-h-12 items-center gap-2 rounded-xl border border-cor-texto/12 bg-cor-fundo/35 px-3 text-cor-texto/90 text-sm md:text-base hover:text-cor-primaria transition-colors"
                  >
