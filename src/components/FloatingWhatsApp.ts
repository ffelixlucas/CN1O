...
function getOrCreateFloatingButton(): HTMLAnchorElement {
  ...
  button.className = [
    ...
    'group inline-flex items-center justify-center w-12 h-12 md:w-14 md:h-14 rounded-full',
  ...
  button.innerHTML = `
    ...
    <svg class="relative w-6 h-6 md:w-7 md:h-7" viewBox="0 0 448 512" fill="currentColor" aria-hidden="true">
