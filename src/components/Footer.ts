      ...
      <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-4 gap-10">
          <div class="space-y-4">
            ...
            <p data-footer-tagline class="text-cor-texto/75 text-sm leading-relaxed">
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm text-cor-texto/75">
              ${sectionLinks
                .map((link) => `<li><a href="${link.href}" class="inline-flex min-h-9 items-center hover:text-cor-primaria transition-colors">${link.label}</a></li>`)
                .join('')}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm text-cor-texto/75">
              <li><a href="${STORE_LINK}" target="_blank" rel="noopener noreferrer" class="inline-flex min-h-9 items-center hover:text-cor-primaria transition-colors">Loja online</a></li>
              <li><a data-footer-pre-matricula href="https://capoeira-base.vercel.app/matricula/cn10" class="inline-flex min-h-9 items-center hover:text-cor-primaria transition-colors">Pre-matricula</a></li>
              <li><a href="/noticias" data-route class="inline-flex min-h-9 items-center hover:text-cor-primaria transition-colors">Blog de noticias</a></li>
            </ul>
          </div>

          <div>
            <h4 class="text-cor-primaria text-xs uppercase tracking-[0.16em] font-semibold mb-4">Contato</h4>
            <ul data-footer-contact-list class="space-y-2 text-sm text-cor-texto/75">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  class="inline-flex min-h-9 items-center gap-2 hover:text-cor-primaria transition-colors"
                >
        ...
        <div data-footer-copy class="border-t border-cor-texto/10 mt-10 pt-6 text-center text-cor-texto/60 text-xs md:text-sm">
